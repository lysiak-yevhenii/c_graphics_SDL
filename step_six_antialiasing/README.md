...
representing how far the plane is from our camera and a normal vector which 
defining the orientation of the plane.
A plane can be represented by a normal vector **N** and a point on the plane **Q**. Normal vector in geometry is an object such as a line or vector that is perpendicular to a given object. So our ray.point **P** on the plane if:

**N** * (**P** - **Q**) = 0; ***(1)***

To find the ray/plane intersection we need to substitute **P(t)** = **E** + **tD**, where **t** >= 0; in equation (1) =>

**N** * (**E** + **tD** - **Q**) = 0;

**t** = (**N** * (**Q** - **E**)) / (**N** * **D**)

If **t** < 0 then the plane is behind the eye point and there is no intersection.

If **t** >= 0 then the intersection point is **E** + **tD**.

If **N** * **D** = 0 then the ray is parallel to the plane, and there is no intersection point.
...
Let's call our point as lacation **p**0 of an object and normal **n** vector as 
...
Intersectin with shpere
----

Intersectin with cone
----
Intersectin with cylinder
----
